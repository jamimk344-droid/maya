...
const finders = {
    darwin(port, config) {
        return new Promise((resolve, reject) => {
            ...
            utils_1.default.exec(cmd, function (err, stdout, stderr) {
                (0, utils_1.debugLog)(!!config.debug, cmd, stdout || '', stderr || '');
                if (err) {
                    reject(err);
                }
                else {
    ...
    android(port, config) {
        return new Promise((resolve, reject) => {
            ...
            ensureDir(dir).then(() => {
                utils_1.default.exec(cmd, (_execErr, execStdout, execStderr) => {
                    (0, utils_1.debugLog)(!!config.debug, cmd, execStdout || '', execStderr || '');
